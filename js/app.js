(() => {
    ...
    function script_headerScroll() {
        ...
        if (scrollPos >= 1) header.classList.add("_header-scroll"); else header.classList.remove("_header-scroll");
    }
    ...
    const videoPlayButtons = document.querySelectorAll(".reviews__slide-play");
